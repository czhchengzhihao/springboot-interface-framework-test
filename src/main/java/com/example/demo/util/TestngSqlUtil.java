...
public class TestngSqlUtil {
    public static List<Object[]> getTestData(String tableName) {
        ...
        try {
            ...
            //建立数据库的连接
            Connection conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/automation", "root", "admin123");
            //判断数据连接是否成功
            if (!conn.isClosed()) {
    ...
    public static void main(String[] args) {
        List<Object[]> cases_management = getTestData("cases_management");
